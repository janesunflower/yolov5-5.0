...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default='data/dji_track1119.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default='weights/dji_track1119.pt', help='model.pt path(s)')
